...
const modal: HTMLElement = document.querySelector("#selection");
...
const setMoney: NodeListOf<HTMLElement> = document.querySelectorAll(".amount");
const apply = document.querySelectorAll(".continue");
const money = document.querySelectorAll("input");
const selected: NodeListOf<HTMLElement> = document.querySelectorAll(".choose");
